...
const initialLoading = computed(() => props.loading && !hasData.value)
...
<template>
  <section class="relative space-y-3">
    ...
    <template v-else-if="hasData">
      ...
      <div
        v-else-if="error"
        class="bg-red-500/10 border border-red-500/20 text-red-300 rounded-2xl px-4 py-3 text-sm"
      >
        {{ error }}
      </div>
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="bg-panel rounded-2xl border border-white/10 shadow-custom p-3 relative overflow-hidden">
            <div v-if="refreshing" class="refresh-sheen" />
        ...
        <div class="bg-panel rounded-2xl border border-white/10 shadow-custom p-4 relative overflow-hidden">
          <div v-if="refreshing" class="refresh-sheen" />
        ...
        <div class="space-y-2">
          ...
          <div class="relative overflow-hidden rounded-2xl">
            <div v-if="refreshing" class="refresh-sheen rounded-2xl" />
        ...
        <div class="space-y-2">
          ...
          <div class="-mx-4 px-4 overflow-x-auto no-scrollbar">
            <div class="flex gap-4 min-w-max pr-4">
              <div class="w-[320px] sm:w-[420px] lg:w-[480px] shrink-0 relative overflow-hidden rounded-2xl">
                <div v-if="refreshing" class="refresh-sheen rounded-2xl" />
